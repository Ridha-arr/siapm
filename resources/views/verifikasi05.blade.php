    ...
    <div class="container mt-4">
        ...
        <div class="card-body">
                    ...
                    <div class="isi">
                        <div class="row p-1">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item">Tambahkan Pesan</li>
                                </ul>
            ...
            <button type="button" class="btn btn-secondary" style="width: 15rem; margin-top: 1rem; width: max-content; margin-left: 0.3rem         ;">
                ...
                <button type="button" class="btn btn-secondary" style="width: 15rem; margin-top: 1rem; width: max-content; margin-left: 0.3rem         ; position: 90px;">
                    Terkendali </i></button> 

                    <button type="button" class="btn btn-secondary" style="width: 15rem; margin-top: 1rem; width: max-content; margin-left: 0.3rem         ;">
                        Tidak Terkendali </i></button> 

                        <button type="button" class="btn btn-secondary" style="width: 15rem; margin-top: 1rem; width: max-content; margin-left: 0.3rem         ;">
                            Kirim Catatan </i></button> 
