                                                        ...
                                                        <div class="mb-3">
                                                            <div class="isi">
                                                                <div class="row p-1">
                                                                    <div class="col-sm-5">
                                                                        <label for="formFile"
                                                                            class="form-label">{{ $keterangan->name }}</label>
                                                                        <br>
                                                                        <div class="progress">
                                                                            <div class="progress-bar btn-secondary"
                                                                                role="progressbar"
                                                                                style="width: {{ $keterangan->laporan ? '100%' : '' }};"
                                                                                aria-valuenow="100" aria-valuemin="0"
                                                                                aria-valuemax="100">
                                                                                {{ $keterangan->laporan ? '100%' : '' }}
                                                                            </div>
                                                                        </div>
