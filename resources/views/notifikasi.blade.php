    ...
    <main>
      ...
      <div class="mx-1" style="margin-left: 20rem !important; margin-top: 13rem">
        <div class="container mt-4">
          <div class="ps-5 mb-4">
            <span class="w-50 h5 m-4" style="font-family: 'Poppins', sans-serif; font-weight: 400; color: #325135; margin-top: 1.5rem; margin-left: 1rem">Notifikasi</span>
            <button class="border-0 bg-transparent mt-4 float-start" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling" style="margin-left: -6rem !important">
                  ...
                  <div class="mb-3 w-100 row mx-auto">
                    <div class="card-subtitle text-left">
                      <div class="card mt-2">
                        <div class="row p-2">
                          <div class="col-2">
                            <div class="card-body rounded-2" style="color: #325135; font-family: 'Poppins', sans-serif; font-weight: 400">AREA</div>
                          </div>
                          <div class="col-2 w-100">
                            <button type="button" class="btn btn-secondary position-relative float-end mt-2">
                              Upload
